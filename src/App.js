...
function App() {
  return (
    <div className='App'>
      ...
      <About
        texto='En 2022, inicié mi formación en desarrollo web, completando diversos cursos en reconocidas 
      ...
      <div className='container-certificados'>
        ...
        <Certificado
          certificado={coder}
          textodiploma='Curso Javascript avanzado'
        />
        <Certificado
          certificado={html5}
          textodiploma='Introduccion a Html5'
        />
        <Certificado
          certificado={css3}
          textodiploma='Introduccion a Css3'
        />
        <Certificado
          certificado={js}
          textodiploma='Interactividad con Javascript'
        />
      </div>
